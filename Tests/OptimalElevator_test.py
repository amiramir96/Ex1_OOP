...
class OptimalElevator_test(TestCase):
    ...
    def test_optimal_elevator(self):
        self.assertEqual(TimeAndPathFuncs.optimal_elevator(self.listE1, self.c0), [self.e0, 34.0], "bad0")
        self.assertEqual(TimeAndPathFuncs.optimal_elevator(self.listE2, self.c0), [self.e2, 24.8], "bad0.1")
        self.assertAlmostEqual(TimeAndPathFuncs.optimal_elevator(self.listE2, self.c1), [self.e2, 37.599999999999994], None, "bad1", 0.1)
        self.assertAlmostEqual(TimeAndPathFuncs.optimal_elevator(self.listE2, self.c2), [self.e2, 47.629999999999995], None, "bad2", 0.1)
        self.assertEqual(TimeAndPathFuncs.optimal_elevator(self.listE3, self.c3), [self.e2, 61.44], "bad3")
        self.assertEqual(TimeAndPathFuncs.optimal_elevator(self.listE3, self.c4), [self.e2, 69.13], "bad4")
        self.assertEqual(TimeAndPathFuncs.optimal_elevator(self.listE3, self.c5), [self.e2, 75.61], "bad5")
