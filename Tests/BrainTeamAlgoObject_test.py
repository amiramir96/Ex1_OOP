...
class BrainTeamAlgoObject_test(TestCase):
    ...
    def test_run(self):
        ...
        self.assertEqual(self.c3.get_allocated_to(), 2, "failed allocatine c3 in real scenario, please go back to work")
        ...
        self.assertEqual(self.c6.get_allocated_to(), 2, "failed real allocatine c6 in realscenario, please go back to work")
        self.assertEqual(self.c11.get_allocated_to(), 2, "failed real allocatine c11 in realscenario, please go back to work")
