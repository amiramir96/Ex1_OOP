...
class BrainTeamAlgoObject_test(TestCase):
    ...
    def test_run(self):
        ...
        self.assertEqual(self.c0.getAllocatedTo(), 0, "failed with BDIKAT SHFIUT, please dont sign this algo")
        smart_run_serious = BrainTeamAlgo.BrainTeamAlgo(self.building2)
        smart_run_serious.run()
        self.assertEqual(self.c00.getAllocatedTo(), 1, "failed allocatine c00 in real scenario, please go back to work")
        self.assertEqual(self.c1.getAllocatedTo(), 2, "failed allocatine c1 in real scenario, please go back to work")
        self.assertEqual(self.c2.getAllocatedTo(), 1, "failed allocatine c2 in real scenario, please go back to work")
        self.assertEqual(self.c3.getAllocatedTo(), 1, "failed allocatine c3 in real scenario, please go back to work")
        self.assertEqual(self.c4.getAllocatedTo(), 1, "failed real allocatine c4 in realscenario, please go back to work")
        self.assertEqual(self.c5.getAllocatedTo(), 1, "failed real allocatine c5 in realscenario, please go back to work")
        self.assertEqual(self.c6.getAllocatedTo(), 1, "failed real allocatine c6 in realscenario, please go back to work")
        self.assertEqual(self.c11.getAllocatedTo(), 1, "failed real allocatine c11 in realscenario, please go back to work")
