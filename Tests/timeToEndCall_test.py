...
class timeToEndCall_test(TestCase):
    ...
    def test_time_to_end_call(self):
        self.assertEqual(genericHelpFuncs.timeToEndCall(self.c0, self.e0), 34.0, "bad0")
        self.assertEqual(genericHelpFuncs.timeToEndCall(self.c0, self.e2), 24.8, "bad0.1")
        self.assertAlmostEqual(genericHelpFuncs.timeToEndCall(self.c1, self.e2), 37.6, None, "bad1", 0.1)
        self.assertAlmostEqual(genericHelpFuncs.timeToEndCall(self.c2, self.e2), 47.62, None, "bad2", 0.1)
        self.assertEqual(genericHelpFuncs.timeToEndCall(self.c3, self.e2), 61.44, "bad3")
        self.assertEqual(genericHelpFuncs.timeToEndCall(self.c4, self.e2), 69.13, "bad4")
        self.assertEqual(genericHelpFuncs.timeToEndCall(self.c5, self.e2), 75.61, "bad5")
