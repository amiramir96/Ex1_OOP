        ...
        for elev in self.building.getListOfElevator():
            ...
            while idx < len(list_of_calls):
                ...
                if list_of_calls[idx].getAllocatedTo() == -1:
                    ...
                    time_curr_mission = Brain.genericHelpFuncs.timeToEndCall(list_of_calls[idx], elev)
                    idx = Brain.genericHelpFuncs.gimmieIdxEndOfTask(list_of_calls, idx, time_curr_mission)
                else:
                    idx = idx + 1
